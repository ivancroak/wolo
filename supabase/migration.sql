...
create table if not exists services (
  ...
  price text not null,
  category text not null check (category in ('repost','like','follow','quote','reply','thread','space','mention','content','ambassador','custom')),
  listing_type text not null default 'offer' check (listing_type in ('offer','request')),
  pricing_category text not null check (pricing_category in ('pay_per_action','full_service','payroll','per_impression','per_engagement','tiered','bounty','auction')),
